...
针对 meta_All_Beauty.jsonl 文件，提取每个 ASIN 的高清主图并下载。
"""
...
# ----------------------------- 基础配置 -----------------------------
DATASET_NAME = "amazon_beauty"  # 明确指明当前处理的数据集名称
...
# ----------------------------- 路径配置 -----------------------------
# 明确指向 Beauty 类的 meta 数据集
DEFAULT_JSONL = "/home/xzhe162/wh_workspace/casual/raw_data/amazon_beauty_raw/meta_All_Beauty.jsonl"
# 图片保存路径
DEFAULT_OUTPUT = "/home/xzhe162/wh_workspace/casual/processed_data/amazon_beauty/pictures"
# 日志保存路径
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="多线程批量下载亚马逊 Beauty 商品主图")
    ...
    # python /home/xzhe162/wh_workspace/casual/data_preprocessing/amazon_beauty_preprocessing/download_images_amazon_beauty.py