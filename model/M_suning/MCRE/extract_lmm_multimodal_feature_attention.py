...
def main():
    ...
    logger.info(f"🎉 FULL_3 数据提取与平滑校准完成！纯数据已保存在: {FINAL_SAVE_PATH}")
...
if __name__ == "__main__":
    ...
    #. python /home/xzhe162/wh_workspace/casual/model/MCRE/extract_lmm_multimodal_feature_attention.py