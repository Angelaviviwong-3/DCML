...
log_filename = f"baseline_comparison_{DATASET_NAME}_v2_0509_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def main():
    ...
    for t_col in tqdm(all_unique_t, desc="Estimating Causal Models"):
        belong_to = []
    ...
    out_path = os.path.join(SAVE_DIR, f"{DATASET_NAME}_Baseline_Comparison_v2_0509.csv")
...
if __name__ == "__main__":
    ...
    # python /home/xzhe162/wh_workspace/casual/model/M_amazon/DML/causal_baseline_comparison_0509_app.py