#!/usr/bin/env python3
"""Prepare independent stage-specific Amazon Purchase-only inputs for CIRS."""
...
def main() -> None:
    ...
    for stage in STAGES:
        ...
        edge_count = 0
        with open(output / f"train_with_time_{stage}_20260718.txt", "w", encoding="utf-8") as handle:
        ...
        np.save(output / f"item_popularity_{stage}_20260718.npy", popularity)
