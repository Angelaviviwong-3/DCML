#!/usr/bin/env python3
"""Train one DICE model per Suning funnel outcome and export audited scores."""
...
def main() -> None:
    ...
    for stage in STAGES:
        ...
        dataset = DICEDataset(
            cache / f"train_{stage}_20260717.txt",
            cache / f"item_pop_{stage}_20260717.json",
            items,
            seed,
        )
    ...
    write_json(diagnostics, baseline_data_dir(root) / "DICE_training_diagnostics_20260717.json", indent=2)
