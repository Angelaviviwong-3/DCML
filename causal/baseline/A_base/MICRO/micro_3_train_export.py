#!/usr/bin/env python3
"""Train one MICRO model per Suning funnel outcome and export audited scores."""
...
def main() -> None:
    ...
    text = np.load(cache / "text_feat_20260717.npy")
    ...
    for stage in STAGES:
        ...
        interactions = read_json(cache / f"train_data_{stage}_20260717.json")
    ...
    write_json(diagnostics, baseline_data_dir(root) / "MICRO_training_diagnostics_20260717.json", indent=2)
